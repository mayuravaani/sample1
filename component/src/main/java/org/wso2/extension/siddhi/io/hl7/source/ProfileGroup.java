...
import org.wso2.extension.siddhi.io.hl7.sink.AbstractModelClass;
...
public class ProfileGroup extends AbstractModelClass implements Cloneable {
    ...
    private static List<Entry> myEntries;
...
*/
    ...
    public static Entry getProfileForMessage(String theEventType, String theTrigger) throws IOException, ProfileException {
